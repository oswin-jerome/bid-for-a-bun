            ...
            <div className="h-full flex flex-col-reverse md:flex-row items-center px-5
             lg:w-[80vw] m-auto rounded-3xl z-10 ">
                <div className="md:flex-1 flex-initial flex flex-col lg:block">
                    ...
                    {/* <a href="#groups" className="flex"> */}

                    <button href="#groups"  className= " bg-app-500 px-8 py-3 mt-10 text-lg rounded-lg shadow hover:shadow-lg hover:bg-app-600 text-white font-normal">
                        <a href="#groups">Join us</a>
                    </button>
                    {/* </a> */}
                </div>
